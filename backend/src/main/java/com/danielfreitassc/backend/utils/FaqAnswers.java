...
import com.danielfreitassc.backend.domain.FaqAnswer;
...
public class FaqAnswers {
    ...
    public FaqAnswers(){
        try {
            JSONTokener tokener = new JSONTokener(new FileInputStream("backend\\src\\main\\resources\\static\\answers.json"));
